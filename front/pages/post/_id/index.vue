    ...
    head() {
      return {
        ...
        meta: [{
          ...
          hid: 'ogimage', property: 'og:image', content: this.post.Images[0] ? this.post.Images[0].src : 'http://veneziar.com/vue-nodebird.png',
        }, {
          hid: 'ogurl', property: 'og:url', content: `http://veneziar.com/post/${this.post.id}`,
        }],
      };
    }
  };
